...
app = Flask(__name__)
model = pickle.load(open('C:/Users/offic/OneDrive/Desktop/minor project/health_gram/model.pkl', 'rb'))
model2 = pickle.load(open('C:/Users/offic/OneDrive/Desktop/minor project/health_gram/model2.pkl', 'rb'))
